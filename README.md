...
Audio and transcript live in your runtime directory (`$XDG_RUNTIME_DIR` when available, otherwise `/tmp`). On most modern systems `$XDG_RUNTIME_DIR` is memory
...
Speak.
Run `asryx` again.
Your text is copied to clipboard and you get a notification.
